...
const App = () => {
  ...
  //GSAP設定
  useGSAP(() => {
    gsap.fromTo('.area02__loop-item01', {
      xPercent: -100
    }, {
      xPercent: 100,
      duration: 160,
    ...
    gsap.fromTo('.area02__loop-item02', {
      xPercent: -200
    }, {
      xPercent: 0,
      duration: 160,
    ...
    gsap.fromTo('.area06__loop-item01', {
      xPercent: 100
    }, {
      xPercent: -100,
      duration: 80,
    ...
    gsap.fromTo('.area06__loop-item02', {
      xPercent: 0
    }, {
      xPercent: -200,
      duration: 80,
    ...
    gsap.fromTo('.area07__loop-item01', {
      yPercent: -100
    }, {
      yPercent: 100,
      duration: 80,
    ...
    gsap.fromTo('.area07__loop-item02', {
      yPercent: -200
    }, {
      yPercent: 0,
      duration: 80,
    ...
    gsap.fromTo('.project__loop-item01', {
      yPercent: 100
    }, {
      yPercent: -100,
      duration: 160,
    ...
    gsap.fromTo('.project__loop-item02', {
      yPercent: 0
    }, {
      yPercent: -200,
      duration: 160,
  ...
  return (
    <div className='container' onMouseDown={refMouseDown} onMouseUp={refMouseUp} onMouseMove={refMouseMove} onClick={refClick} ref={dragRef}>
      <div className='container__inner' ref={container}>
        ...
        <div className='area02'>
          ...
          <section className='instagram'>
            <ul className='instagram__list'>
              <li><img src="./images/dummy.jpg" alt="" /></li>
              <li><img src="./images/dummy.jpg" alt="" /></li>
              <li><img src="./images/dummy.jpg" alt="" /></li>
              <li><img src="./images/dummy.jpg" alt="" /></li>
              <li><img src="./images/dummy.jpg" alt="" /></li>
          ...
          <section className='kohei'>
            <h2 className='kohei__tit01'><img src="./images/kohei_name.svg" alt="植村康平" /></h2>
            <div className='kohei__profile'>
              <p>建築家であり、娘2人を育てる父親<br />
                名古屋市名東区西山商店街を拠点にまちづくり活動を行う。<br />
                植村康平建築設計事務所を主宰し、ニシヤマナガヤ、<br />
                未完美術館、暮らせる図書館の運営にも携わる。<br />
                仕組みづくり、空間づくり、ものづくりが得意な、<br />
                元高校球児。
              </p>
            </div>
        ...
        <div className='area03'>
          <section className='no03'>
            ...
            <div className='no03__txt01'>
              <p>SiKi designが手がける 「しくみキュレーション」とは、<br />
          ...
          <section className='sachie'>
            <h2 className='sachie__tit01'><img src="./images/sachie_name.svg" alt="藤野幸江" /></h2>
            <div className='sachie__profile'>
              <p>まちコーディネーターであり暮らせる図書館の館長<br />
                百貨店に長く勤め、イベントの企画やチームマネジ<br />
                メントに携わった経験を活かして、現在の暮らせる<br />
                図書館で様々なコミュニティづくりを担っている。<br />
                2019年長女出産。趣味は星読みやコーヒー、絵を<br />
                描くことや神社巡りなど多岐に渡る。
              </p>
            </div>
        ...
        <div className='area04'>
          ...
          <section className='project'>
            <h2 className='project__tit01'><img src="./images/project_tit01.svg" alt="これまでのプロジェクト" /></h2>
            <div className='project__map'>
              <div className='project__txt01'>
                <p>SiKi designが<br />
                  これまでに携わった国内のプロジェクトを紹介。</p>
                <p>その他に<br />
                  「行った事がある地域」<br />
                  「行ってみたい地域」をマッピング！</p>
              </div>
          ...
          <section className='no06'>
            ...
            <form className='no06__form01' id='contact' name='contact' action="">
              <ul className='no06__list01'>
                <li><label><input id='item01' name='item01' type="checkbox" /><span>持て余している空き家がある</span></label></li>
                <li><label><input id='item02' name='item02' type="checkbox" /><span>コミュニティをつくりたい</span></label></li>
                <li><label><input id='item03' name='item03' type="checkbox" /><span>まだ世にない新しいものをつくりたい</span></label></li>
                <li><label><input id='item04' name='item04' type="checkbox" /><span>話を聞かせてほしい（視察依頼）</span></label></li>
                <li><label><input id='item05' name='item05' type="checkbox" /><span>その他</span></label></li>
              </ul>
              <ul className='no06__list02'>
                <li><label><input id='item06' name='item06' type="checkbox" /><span>今あるスペースをもっと活用したい</span></label></li>
                <li><label><input id='item07' name='item07' type="checkbox" /><span>場づくりをしたい</span></label></li>
                <li><label><input id='item08' name='item08' type="checkbox" /><span>まちの中で何か面白いことをやりたい</span></label></li>
                <li><label><input id='item09' name='item09' type="checkbox" /><span>話をしてほしい（講演依頼）</span></label></li>
                <li><label><input id='item10' name='item10' type="checkbox" /><span>やる気と熱意はある！！</span></label></li>
              </ul>
            </form>
      ...
      <div className='zoom'>
        <button className='plus' onClick={zoomUp}><img src="./images/icon_plus.svg" alt="拡大する" /></button>
        <button className='minus' onClick={zoomDown}><img src="./images/icon_minus.svg" alt="縮小する" /></button>
      </div>
    </div>
  );
};
